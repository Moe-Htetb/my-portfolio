            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              <div className="grid gap-5 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="border-border/40 bg-accent/30 transition-colors focus:border-cyan-accent/50"
                    {...register("name")}
                  />
                  {errors.name && (
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={5}
                  className="resize-none border-border/40 bg-accent/30 transition-colors focus:border-cyan-accent/50"
                  {...register("message")}
                />
                {errors.message && (
                  <p className="text-xs text-destructive">
